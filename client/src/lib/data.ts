...
export const experienceRoles = [
  {
    ...
    company: "Luciq.ai",
    impact:
      "Built MCP server shipped to 10+ enterprise betas. Ran rapid validation sprints with AI-assisted prototyping. Workflows & Alerting squad.",
  },
  {
    year: "2024",
